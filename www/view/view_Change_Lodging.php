    ...
    <div class="12u">
        ...
        <section class="box">
			<form method="post" action="index.php?action=change_Lodging&id=<?php echo $_GET['id'];?>" enctype="multipart/form-data">
				...
				<div class="row uniform 50%">
					<div class="6u 12u(mobilep)">
						<input type="text" name="code" value="<?php echo htmlspecialchars($lodging['Code']);?>" placeholder="Code de résertvation*" maxlength="45"/>
					</div>
					<div class="6u 12u(mobilep)">
                ...
                <div class="row uniform 50%">
                    <div class="12u 12u(mobilep)">
						<input type="text" name="note" placeholder="Remarque*" value="<?php echo htmlspecialchars($lodging['Note']);?>" maxlength="280"/>
                    </div>
                </div>
				<div class="row uniform 50%">
					<div class="6u 12u(mobilep)">
