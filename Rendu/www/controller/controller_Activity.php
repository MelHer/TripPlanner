                ...
                if($_POST)
                {
                    ...
                    if($checking == "")
                    {
                        ...
                        if(isset($image_Checker)) //prevent creation if image not valid
                        {
                            ...
                            $id = insert_Activity($_GET['id'],$_POST['description'],$_POST['date_Activity'],$_POST['price'],$_POST['link'],$_POST['note'],$image_Checker);
                        }
...
function change_Activity()
{
    ...
    if(isset($_SESSION['user']) && !empty($_SESSION['user']))
    {
        ...
        if(isset($_GET['id']) && !empty($_GET['id']))
        {
            ...
            $activity = select_Activity($_SESSION['id'],$id_Activity);
            if(isset($activity) && !empty($activity))
            {
                ...
                if($_POST)
                {
                    ...
                    if($checking == "")
                    {
                        ...
                        if(isset($image_Checker)) //prevent creation if image not valid
                        {
                            update_Activity($activity['idActivity'],$_POST['description'],$_POST['date_Activity'],$_POST['price'],$_POST['link'],$_POST['note'],$image_Checker);
                        }
