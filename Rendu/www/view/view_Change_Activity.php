			...
			<form method="post" action="index.php?action=change_Activity&id=<?php echo $_GET['id'];?>" enctype="multipart/form-data">
				<div class="row uniform 50%">
					<div class="12u 12u(mobilep)">
						<input type="text" name="description" placeholder="Description*" value="<?php echo htmlspecialchars($activity['Description']);?>" maxlength="45" required/>
					</div>
				</div>
                <div class="row uniform 50%">
                    <div class="6u 12u(mobilep)">
                        <div>Prix*:</div>
						<input type="number" id="price" onchange="two_Decimal()" name="price" value="<?php echo $activity['Price'];?>" value="0" min="0" max="900000" step="0.01" required/>
                        <span>CHF</span>
                    </div>
                    <div class="6u 12u(mobilep)">
				...
				<div class="row uniform 50%">
					<div class="12u 12u(mobilep)">
						<input type="text" name="link" placeholder="Lien" value="<?php echo htmlspecialchars($activity['Link']);?>" maxlength="255"/>
					</div>
				</div>
                <div class="row uniform 50%">
                    <div class="12u 12u(mobilep)">
						<textarea  name="note"  maxlength="280" placeholder="Remarque"><?php echo htmlspecialchars($activity['Note']);?></textarea>
                    </div>
                </div>
				<div class="row uniform 50%">
					<div class="6u 12u(mobilep)">
