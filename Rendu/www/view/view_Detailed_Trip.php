				            ...
				            <tbody>
                                <?php 
                                    foreach($lodgings as $lodging)
                                    {
                                        ...
                                        echo '</tr>';
                                        echo '<tr>';
                                        echo '<td class="text_Center" colspan="6" class="flow_Control">Code: '.htmlspecialchars($lodging['Code']).'<br> Remarque: '.htmlspecialchars($lodging['Note']).'</td>';
                                        echo '</tr>';
                                    }
                                ?>
                            </tbody>
                                ...
                                <?php 
                                    foreach($activities as $activity)
                                    {
                                        ...
                                        else
                                        {
                                            if($activity['Date'] != null)
                                            {
                                                 echo '<td class="text_Center">Le: '.date_format($day,"d-m-Y").'<br><a href="'.htmlspecialchars($activity['Link']).'">lien</a></td>';     
                                            }
                                            else
                                            {
                    ...
                    <form method="post" action="index.php?action=change_Trip_Privacy&id=<?php echo $trip['idTrip'];?>">
				        ...
				        <div class="row uniform 50%">
					        <div class="12u" align="center">
						        <ul class="actions">
					                <li><input type="submit" value="Enregistrer la visibilité" /></li>
						        </ul>
					        </div>
				        </div>
			        </form>            
