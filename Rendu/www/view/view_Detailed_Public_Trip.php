        ...
        <section class="box">
            ...
            <div class="row">
                ...
                <div class="4u 12u(mobilep)">
                    <h3>Début: <span id="date_Start"><?php
                ...
                <div class="4u 12u(mobilep)">
                    <h3>Prix total: <?php
                                    ...
                                    echo number_format($total_Cost,2,'.',"'")." CHF";
                            ?>
                </div>
            </div>
				            ...
				            <tbody>
                                <?php 
                                    foreach($lodgings as $lodging)
                                    {
                                        ...
                                        {
                                            echo "<td><a class='no_Border' href='images/user".$participant_Trip['fkUser_Organizer']."/".$participant_Trip['idTrip']."/Lodging/".$lodging['idLodging'].".jpg' target='_blank'><img class='thumbnail' src='images/user".$participant_Trip['fkUser_Organizer']."/".$participant_Trip['idTrip']."/Lodging/".$lodging['idLodging'].".jpg'></a></td>";
                                        }
                                        else
                                        {
                                        ...
                                        {
                                            echo '<td class="text_Center">'.$lodging['Price'].' CHF<br><a href="'.htmlspecialchars($lodging['Link']).'" target="_blank">lien</a></td>';   
                                        }
                                        echo '</tr>';
                                        echo '<tr>';
				            ...
				            <tbody>
                                <?php 
                                    foreach($transports as $transport)
                                    {
                                        ...
                                        {
                                            echo "<td><a class='no_Border' href='images/user".$participant_Trip['fkUser_Organizer']."/".$participant_Trip['idTrip']."/Transport/".$transport['idTransport'].".jpg' target='_blank'><img class='thumbnail' src='images/user".$participant_Trip['fkUser_Organizer']."/".$participant_Trip['idTrip']."/Transport/".$transport['idTransport'].".jpg'></a></td>";
                                        }
                                        else
                                        {
                                        ...
                                        {
                                            echo '<td class="text_Center">'.$transport['Price'].' CHF<br><a href="'.htmlspecialchars($transport['Link']).'" target="_blank">lien</a></td>';   
                                        }
                                        echo '</tr>';
                                        echo '<tr>';
				            ...
				            <tbody>
                                <?php 
                                    foreach($activities as $activity)
                                    {
                                        ...
                                        {
                                            echo "<td><a class='no_Border' href='images/user".$participant_Trip['fkUser_Organizer']."/".$participant_Trip['idTrip']."/Activity/".$activity['idActivity'].".jpg' target='_blank'><img class='thumbnail' src='images/user".$participant_Trip['fkUser_Organizer']."/".$participant_Trip['idTrip']."/Activity/".$activity['idActivity'].".jpg'></a></td>";
                                        }
                                        else
                                        {
                                        ...
                                        else
                                        {
                                            if($activity['Date'] != null)
                                            {
                                                 echo '<td class="text_Center">Le: '.date_format($day,"d-m-Y").'<br><a href="'.htmlspecialchars($activity['Link']).'" target="_blank">lien</a></td>';     
                                            }
                                            else
                                            {
                                                echo '<td class="text_Center"><a href="'.htmlspecialchars($activity['Link']).'" target="_blank">lien</a><br><br></td>';
                                            }
                                        }
                                        echo '</tr>';
                                        echo '<tr>';
