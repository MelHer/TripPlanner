			...
			<form method="post" action="index.php?action=change_Transport&id=<?php echo $_GET['id'];?>" enctype="multipart/form-data">
                ...
                <div class="row uniform 50%">
					...
					<div class="6u 12u(mobilep)">
						...
						<input type="date" id="end"  name="date_End" value="<?php echo $transport['Day_End'];?>" onblur="check_Date()" min="<?php echo $transport['Day_Start'];?>" required/>
					</div>
				</div>
                <div class="row uniform 50%">
					<div class="6u 12u(mobilep)">
                ...
                <div class="row uniform 50%">
                    <div class="6u 12u(mobilep)">
                        <div>Prix*:</div>
						<input type="number" id="price" onchange="two_Decimal()" value="<?php echo $transport['Price'];?>" name="price" value="0" min="0" max="900000" step="0.01" required/>
                        <span>CHF</span>
                    </div>
                    <div class="6u">
						<div class="select-wrapper">
							<select name="type">
								<?php
                                    ...
                                    foreach($transport_Types as $transport_Type) //Then add the others
                                    {
                                        if($transport_Type['idTransport_Type'] != $transport['fkTransport_Type'])
                                        {
                                            echo "<option value='".$transport_Type['idTransport_Type']."'>".$transport_Type['Type']."</option>";   
				...
				<div class="row uniform 50%">
					<div class="6u 12u(mobilep)">
						<input type="text" name="code" value="<?php echo htmlspecialchars($transport['Code']);?>" placeholder="Code de réservation"/>
					</div>
					<div class="6u 12u(mobilep)">
                ...
                <div class="row uniform 50%">
                    <div class="12u 12u(mobilep)">
						<textarea  name="note"  maxlength="280" placeholder="Remarque"><?php echo htmlspecialchars($transport['Note']);?></textarea>
                    </div>
                </div>
				<div class="row uniform 50%">
					<div class="6u 12u(mobilep)">
